...
const About: React.FC = () => {
  ...
  return (
    <div className="w-full h-auto my-5">
      ...
      <p className="text-gray-500 h-full w-full text-[15px]">provide your Project Name and the link</p>
      {
      ...
      <form  key={index} className={` ${item.isHoverd ? 'h-[560px] ' : 'h-[60px] '} border-b border-gray-300  overflow-hidden transition-all duration-400 my-6  w-full`}>
        <div   className="flex justify-between items-center cursor-pointer hover:text-blue-500">
          <h4 onClick={() =>HoverEducationBox(index)} className="text-[19px] hover:text-blue-500 text-gray-600">Projects</h4>
        ...
        <div className="mt-1 flex space-x-3">
          <div className="space-y-2 w-full">
            ...
            <input type="text" className="w-full form-control bg-white" />
          </div>
        </div>
