...
const About: React.FC = () => {
  ...
  return (
    <div className="w-full h-auto my-5">
      <h2 className="text-green-600 font-semibold w-full h-full ">Awards</h2>
      <p className="text-gray-500 h-full w-full text-[15px]">provide your Detail information about your Awards</p>
      {
      ...
      <form  key={index} className={` ${item.isHoverd ? 'h-[560px] ' : 'h-[60px] '} border-b border-gray-300  overflow-hidden transition-all duration-400 my-6  w-full`}>
        <div   className="flex justify-between items-center cursor-pointer hover:text-blue-500">
          <h4 onClick={() =>HoverEducationBox(index)} className="text-[19px] hover:text-blue-500 text-gray-600">Award Title</h4>
        ...
        <div className="mt-7 flex w-full">
          <div className=" space-y-2 w-full">
            ...
            <input type="text" name="AwardTitle" className="form-control bg-white" />
          </div>
        </div>
        ...
        <div className="mt-3 flex space-x-3">
          <div className="space-y-2">
            ...
            <input type="text" name="Organization" className="form-control bg-white" />
          </div>
          <div className="space-y-2">
            <label htmlFor="Location">Location</label>
            <input type="text" name="Location" className="form-control bg-white" />
          </div>
        </div>
        ...
        <div className="mt-3 flex space-x-3">
          <div className="space-y-2 w-full">
            ...
            <input type="text" className="form-control w-full bg-white" />
          </div>
        </div>
